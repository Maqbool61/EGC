---
name: egc
description: Development conventions and patterns for EGC - Extended Global Context. JavaScript project with conventional commits.
---

# EGC - Extended Global Context Conventions


## Overview

This skill teaches the development patterns and conventions used in EGC (Extended Global Context).
